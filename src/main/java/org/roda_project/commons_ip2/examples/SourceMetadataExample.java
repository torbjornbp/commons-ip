package org.roda_project.commons_ip2.examples;
...
/**
 * Example class for testing source metadata functionality.
 */
public class SourceMetadataExample {
  public static void main(String[] args) throws Exception {
    // Create SIP
    SIP sip = new EARKSIP("sip1", IPContentType.getMIXED(), null, "2.2.0");
    ...
    Path dataPath = Paths.get("/Users/torbjornpedersen/testpakke/primary/Untitled01.mov");
